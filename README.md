# PixelDatabase.Net
This is the original code for .Net Framework. The code for DataJuggler.PixelDatabase, which targets Dot Net Core 3.1, is actually from this code.
...
Now that this project is a class library, I plan on adding more features to both the .Net Framework and Dot Net Core versions.
